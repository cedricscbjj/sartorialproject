...
const imagesData = [
    { url: "image1.jpg", description: "Les gens sont souvent tristes et ça se voit ...", source: "Source photo" },
    { url: "image2.jpg", description: "Violet", source: "Source photo" },
    { url: "image3.jpg", description: "Partons du principe que si vous fuyez ces couleurs...", source: "Source photo" },
    { url: "image4.jpg", description: "Parmi les influenceurs dit sartorial il y’en a...", source: "Source photo : Vinted" },
    { url: "image5.jpg", description: "Akamine Yukio envoie une balle virtuelle a travers...", source: "Source photo : Drake’s Instagram Account" },
    { url: "image6.jpg", description: "Un magnifique blazer inspiré des années 70.", source: "Source photo : Ralph Lauren" },
    { url: "image7.jpg", description: "Les vestes croisées donnent souvent une allure...", source: "Source photo : Pitti Uomo" },
    { url: "image8.jpg", description: "Voici un exemple de tailoring italien moderne.", source: "Source photo : Ring Jacket" },
    ...
    { url: "image12.jpg", description: "Les costumes trois pièces reviennent en force.", source: "Source photo : Huntsman" },
    ...
    { url: "image16.jpg", description: "L’histoire du style Ivy League et son influence actuelle.", source: "Source photo : Ivy Style Blog" },
    ...
    { url: "image18.jpg", description: "L’art du layering en hiver.", source: "Source photo : Drake’s Lookbook" },
    { url: "image19.jpg", description: "Les meilleurs souliers pour une garde-robe versatile.", source: "Source photo : Crockett & Jones" },
    { url: "image20.jpg", description: "Comment bien choisir une chemise en fonction de son col.", source: "Source photo : Turnbull & Asser" },
    { url: "image21.jpg", description: "Les lunettes les plus iconiques du style preppy.", source: "Source photo : Persol" },
    { url: "image22.jpg", description: "Pourquoi le lin est un indispensable de l’été.", source: "Source photo : Anglo-Italian" },
    { url: "image23.jpg", description: "Un trench-coat bien coupé peut transformer une tenue.", source: "Source photo : Burberry Archives" },
